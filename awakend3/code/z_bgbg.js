class Z_bgbg {
	constructor() {
		...
		this.bgcol1 = color(143, 95, 82, 169);
	}
	f_posset() {
		this.posbgbg = [
	...
	f_fornyu_up() {
		// this.bgcol1 = qb.colrndm(0.8)
		this.bgcol1 = color(qb.rndm(70,130), qb.rndm(70,130), qb.rndm(70,130), 169);
		if ( Math.random()< 0.8 )  this.bgcol1 = color(143, 95, 82, 169);
	...
	f_efdraw(_g) {
		...
		qfill.drawfillv2(_g, this.vt_test, qb.colrndm(0.45), qb.rndmint(30,60), _angle2, 19, [-0.2, 1.2], 1, .4)
		qfill.drawfillv2(_g, this.vt_test, qb.colrndm(0.55), qb.rndmint(30,60), _angle3, 19, [-0.2, 1.2], 1, .4)
		...
		if (nnyu.kyouseilock) qfill.drawfillv2(_g, this.vt_test2, "#333344a9", 34, _angle4, 12, [0, 1], 0.04)
			...
			qfill.drawfillv2(_g, this.vt_test2, this.bgcol1, 34, _angle4, 12, [0, 1], 0.04)
		}
