(function(root) {
	...
	Object.defineProperty(Pizzicato, 'volume', {
		...
		set: function(volume) {
			if (Pz.Util.isInRange(volume, 0, 15) && masterGainNode)
	...
	Pizzicato.Sound.prototype = Object.create(Pizzicato.Events, {
		...
		volume: {
			...
			set: function(volume) {
				if (Pz.Util.isInRange(volume, 0, 15) && this.masterVolume)
		...
		sustain: {
			...
			set: function(sustain){
				...
				if (Pz.Util.isInRange(sustain, 0, 15))
	...
	Pizzicato.Group.prototype = Object.create(Pz.Events, {
		...
		volume: {
			...
			set: function(volume) {
				if (Pz.Util.isInRange(volume, 0, 15))
					this.masterVolume.gain.value = volume;
			}
		},
